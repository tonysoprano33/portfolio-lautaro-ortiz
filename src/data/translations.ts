...
export const translations = {
  es: {
    hero: {
      ...
      headline: "Convierto datos en",
      headlineAccent: "resultados medibles",
      description: "Especialista en transformar datos complejos en insights accionables. Ayudo a empresas a tomar decisiones basadas en datos que impulsan crecimiento real.",
  ...
  en: {
    hero: {
      ...
      headlineAccent: "measurable results",
      description: "Specialist in transforming complex data into actionable insights. I help companies make data-driven decisions that drive real growth.",
