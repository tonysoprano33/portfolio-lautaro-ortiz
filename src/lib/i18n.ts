    ...
    projectDetails: {
      ...
      nexoio: {
        ...
        slides: [
          ...
          "Comparador local: compara variables de equipos, revisa 60 registros historicos y exporta la seleccion en CSV",
          "Detalle de equipo: valores actuales, grafico de rango, mini tendencia e historico del Motor 1",
          "Reportes offline: historico local, filtros por variable, conteo de registros y flujo de exportacion CSV",
        ],
      },
    },
  },
